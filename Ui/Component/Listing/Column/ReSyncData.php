...
class ReSyncData extends \Magento\Ui\Component\Listing\Columns\Column
{
     ...
     * @param \DamConsultants\Idex\Model\BynderSycDataFactory $BynderSycDataFactory
    ...
    public function __construct(
        ...
        \DamConsultants\Idex\Model\BynderSycDataFactory $BynderSycDataFactory,
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                try {
                    ...
                    if (isset($item['id']) && $this->authorization->isAllowed('DamConsultants_Idex::resync')) {

...
class CustomerVisibilityOption extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init(\DamConsultants\Idex\Model\ResourceModel\CustomerVisibilityOption::class);
    }
}

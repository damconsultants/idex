...
define([
  ...
  return Textarea.extend({
    ...
    clickBynderImage: function () {
      ...
      var AjaxUrl =
        arrayOfStrings[0] + "//" + arrayOfStrings[2] + "/bynder/index/logo";
     ...
     * Click event for Insert Variable Button
     */
    clickBynderVideo: function () {
      var btn_class = jQuery(".cms_bynder_video_action_btn").attr("class");
      var exp = btn_class.split(" ");
      var b_url = exp[exp.length - 1];
      var base_url = window.location.href;
      var delimiter = "/";
      ...
      console.log(AjaxUrl);
      var docicon = "https://img.icons8.com/cotton/2x/regular-document.png";
      var p_id = jQuery(".cms_bynder_video_action_btn").parent().parent().attr("id");
      var ident = "#";
      if (p_id == "" || p_id == undefined) {
        var res = jQuery(".cms_bynder_video_action_btn")
          .parent()
          .parent()
          .attr("class");
        if (res != undefined && res != "") {
                              ...
                              if ($.inArray(type_val, selected_types) != -1) {
                                ...
                                if (res.dataset_type == "IMAGE") {
                                  ...
                                  if (video_url[res.bynderid] != undefined) {
                                    ...
                                    tag_html +=
                                      '<video controls class="bynder-view" poster="'+ res.main_link +'" ><source src="' +
                                      v_url +
                                      '" type="video/mp4"><source src="' +
                                      v_url +
                                      '" type="video/ogg">Your browser does not support HTML video.</video>';

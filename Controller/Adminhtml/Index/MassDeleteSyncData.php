...
use DamConsultants\Idex\Model\ResourceModel\Collection\BynderConfigSyncDataCollectionFactory;
...
class MassDeleteSyncData extends Action
{
     ...
     * @param \DamConsultants\Idex\Model\BynderConfigSyncDataFactory $bynderFactory
     */
    public function __construct(
        ...
        \DamConsultants\Idex\Model\BynderConfigSyncDataFactory $bynderFactory
    ) {
        $this->filter = $filter;
    ...
    {
        return $this->authorization->isAllowed('DamConsultants_Idex::massdelete');
    }
    /**
     * Execute
     */
